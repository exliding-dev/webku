...
const PORTFOLIO_ITEMS = [
  {
    ...
    image: "/Portfolio/SMA insan cendikia.png",
  ...
  },
  {
    ...
    category: "company",
    categoryLabel: "Company Profile",
    image: "/Portfolio/autobintantaxi.jpg",
  ...
  },
  {
    ...
    image: "/Portfolio/webgissolo.png",
  ...
  },
  {
    ...
    category: "company",
    categoryLabel: "Company Profile",
    image: "/Portfolio/webpuskesmas.jpg",
          ...
          {STATS.map((stat, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                <span className="block text-4xl font-display font-black text-foreground mb-1 group-hover:text-brutal-border">
                  {stat.value}
                </span>
                <span className="text-xs font-black uppercase tracking-widest text-foreground/80 group-hover:text-brutal-border">
                  {stat.label}
                </span>
              </div>
            </motion.div>
