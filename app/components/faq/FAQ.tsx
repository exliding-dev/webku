...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Untuk paket Starter, pengerjaan memakan waktu 3–5 hari kerja. Paket Pro membutuhkan 5–7 hari kerja, sedangkan Paket Bisnis sekitar 7–14 hari kerja tergantung kompleksitas fitur yang diminta. Kami selalu berkomunikasi progres secara transparan.",
  },
  {
    question: "Apakah saya bisa request desain custom?",
    answer:
      "Tentu saja! Semua paket kami menyediakan desain yang disesuaikan dengan identitas brand Anda. Kami akan berdiskusi tentang warna, layout, dan style yang Anda inginkan sebelum mulai mengerjakan.",
  },
  {
    question: "Apakah website sudah termasuk domain dan hosting?",
    answer:
      "Ya, semua paket sudah termasuk domain (.com atau .net) gratis selama 1 tahun dan hosting dengan spesifikasi sesuai paket yang dipilih. Anda tidak perlu repot mengurus infrastruktur teknis.",
  },
  {
    question: "Bagaimana dengan maintenance setelah website jadi?",
    answer:
      "Kami menyediakan support after-launch untuk semua paket. Jika ada update konten, perbaikan bug, atau pertanyaan teknis, tim kami siap membantu. Untuk maintenance rutin bulanan, tersedia paket terpisah dengan harga terjangkau.",
  },
  {
    question: "Apakah website-nya SEO-friendly?",
    answer:
      "Absolutly! Semua website yang kami buat sudah dioptimasi untuk SEO on-page, termasuk meta tags, struktur heading, sitemap, loading speed optimization, dan mobile responsiveness. Kami juga menyediakan artikel SEO-ready sesuai paket.",
  },
  {
    question: "Metode pembayaran apa saja yang tersedia?",
    answer:
      'Kami menerima pembayaran melalui transfer bank (BCA, BRI, Mandiri, BNI), e-wallet (GoPay, OVO, Dana), dan juga bisa dengan sistem cicilan. Pembayaran dilakukan 50% di awal dan 50% setelah website selesai.',
  },
];
