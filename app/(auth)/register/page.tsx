...
import { registerAction, RegisterState } from "@/lib/actions/auth.actions"
      ...
      <div className={`auth-wrapper ${mounted ? "auth-animate-in" : "auth-pre-animate"}`}>
        ...
        <div className="auth-card auth-card-wide">
          ...
          <div className="auth-card-header">
            ...
            <div className="auth-badge">DAFTAR AKUN</div>
          </div>
          ...
          <div className="auth-card-body">
            ...
            {state.success ? (
              <div className="auth-success-full">
                ...
                <h1 className="auth-title" style={{ textAlign: "center" }}>BERHASIL!</h1>
              ...
              <>
                ...
                <p className="auth-subtitle">Buat akun klien gratis &amp; mulai akses template premium</p>
                ...
                {state.error && (
                  <div className="auth-alert auth-alert-error" role="alert">
                    ...
                    <div>
                      <strong style={{ display: "block", marginBottom: "2px" }}>Pendaftaran gagal</strong>
                ...
                <form action={action} className="auth-form" noValidate>
                  ...
                  {/* Terms checkbox */}
                  <div className="auth-check auth-stagger-3">
                    <input
                      id="register-terms"
                      name="terms"
                      type="checkbox"
                      ...
                      disabled={isPending}
                    />
                    <label htmlFor="register-terms" className="auth-check-label">
                      Saya setuju dengan{" "}
                      <Link href="/syarat-ketentuan" className="auth-link-inline">
                        Syarat &amp; Ketentuan
                      </Link>{" "}
                      yang berlaku
                    </label>
                ...
                <div className="auth-links auth-stagger-4">
                  ...
                  <Link href="/login" className="auth-link auth-link-cta">
